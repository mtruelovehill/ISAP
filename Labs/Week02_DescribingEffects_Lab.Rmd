---
title: "Week 2: CIs, Effect Sizes, and Power"
output:
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
```{r, echo = F}
tags$style(HTML(".js-irs-0 .irs-from, .js-irs-0 .irs-to, .js-irs-0 .irs-bar {background: #f7705c; border-color: transparent}"))
tags$style(HTML(".js-irs-1 .irs-from, .js-irs-1 .irs-to, .js-irs-1 .irs-bar {background: #f7705c; border-color: transparent}"))
tags$style(HTML(".js-irs-2 .irs-single, .js-irs-2 .irs-bar {background: #4CA384; border-color: transparent}"))
tags$style(HTML(".js-irs-3 .irs-single, .js-irs-3 .irs-bar {background: #4CA384; border-color: transparent}"))
tags$style(HTML(".js-irs-4 .irs-single, .js-irs-4 .irs-bar {background: #4CA384; border-color: transparent}"))
tags$style(HTML(".js-irs-5 .irs-single, .js-irs-5 .irs-bar {background: #4CA384; border-color: transparent}"))
tags$style(HTML(".js-irs-6 .irs-single, .js-irs-6 .irs-bar {background: #4CA384; border-color: transparent}"))
tags$style(HTML(".js-irs-7 .irs-single, .js-irs-7 .irs-bar {background: #4CA384; border-color: transparent}"))
tags$style(HTML(".js-irs-8 .irs-single, .js-irs-8 .irs-bar {background: #4CA384; border-color: transparent}"))
```
