...
quiz(caption = '',
     ...
     question('You are testing the association between hospital size and stress in nurses. You compare nurse stress from nurses across 3 different hospital sizes (small, medium, and large). Assume that stress is a continuous variable. Which of the following analyses could be used to to test this association?',
