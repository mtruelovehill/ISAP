...
Mediation analysis with PROCESS macro Version 4.2 (Hayes, 2017) was used to investigate the hypothesis that sleep mediates the effect of screen time on attention span in children. Results showed that screen time was a significant predictor of sleep, $\beta$ = -0.52, $SE$ = 0.09, $p$ < .001. Both screen time, $\beta$ = -0.52, $SE$ = 0.09, $p$ < .001, and sleep, $\beta$ = -0.52, $SE$ = 0.09, $p$ < .001, significantly predicted attention span, explaining 25% of its variance, $F$(2, 119) = 20.10, $p$ < .001.

The indirect effect was tested using a percentile bootstrap estimation approach with 5000 samples. These results indicated the indirect coefficient was significant, $\beta$ = -0.16, $SE$ = 0.05, 95% CI[-0.26,-0.07]. However, screen time remained a significant predictor of attention even after controlling for sleep, $\beta$ = -0.16, $SE$ = 0.08, $p$ = .04, indicating partial mediation. See Figure 1 for a summary of key results.
