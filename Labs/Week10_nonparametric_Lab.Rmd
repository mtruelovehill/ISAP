...
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_ownCarDesc.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_parentCarHist.png')

knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_ownCarHist.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_parentCarQQ.png')

knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_ownCarQQ.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_ownershipBoxplot.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_ttestLevene.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_selfHist.png')

knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_parentHist.png')

knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_friendHist.png')
```

As before, `SafetyRating` within each group does not appear to follow a normal distribution. The Q-Q plots support this:

```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_selfQQ.png')

knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_parentQQ.png')

knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_friendQQ.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_passengerBoxplot.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_ANOVAlevene.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_mwTest.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_kwTest.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('https://mtruelovehill.github.io/ISAP/Labs/images/nonparametric_pwc.png')
```
