...
Recall from the [lecture](https://mtruelovehill.github.io/PRM/Lectures/Week03_NHST_lecture.html#37) that a $p$-value is the probability of obtaining a statistical test value at least as extreme as the value observed, given that the null hypothesis is true. 
