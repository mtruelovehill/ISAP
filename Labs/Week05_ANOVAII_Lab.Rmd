...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/anovaII_qqPlotTime1.png')
```

```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/anovaII_qqPlotTime2.png')
```
...
+ p-values
+ effect sizes
+ p - values of all simple effects comparisons (if interaction is significant)
