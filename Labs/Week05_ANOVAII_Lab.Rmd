...
```{r, echo = F}
dat <- read.csv('https://mtruelovehill.github.io/ISAP/Labs/Week5LabData.sav')
datInfo <- data.frame(VariableName=colnames(dat), 
                      Description=c('Age in years', 'Sex', 'Levels: 0 = Waitlist; 1 = Play Therapy, 2 = Pet Therapy', 'pre-intervention RCDS score (possible values = 0-)', 'post-intervention RCDS score (possible values = 0-)'))
