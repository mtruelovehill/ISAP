...
quiz(caption = 'Check Your Results',
     question_numeric("What is the numerator df associated with the interaction effect? ",
              answer(2, correct = T),
              message = "The numerator df for the interaction is 2. See the solution tab for how this is calculated."),
...
K = number of levels in Independent Variable 1 (`Condition`)
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week5_levenesTest.png')
```
