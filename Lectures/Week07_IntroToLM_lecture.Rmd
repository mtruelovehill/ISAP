...
We conducted a **simple linear regression** to determine the effect of <span style = "color:#CD826E"> <b> revision time (in hours per week) </span></b> on <span style = "color:#CD826E"> <b> course performance (measured as the course average) </span></b>. The $\alpha$ threshold was set at .05 for all analyses. An a priori power analysis indicated that 90 participants were sufficient to detect an effect of $R^2$ = .1 with a power of 80% and an $\alpha$ threshold of .05.

Simple linear regression indicated that revision time explained 56% of the variance in course performance <span style = "color:#BB5A73"><b> $F$(1, 119) = 150.42, $p$ < .001 </span></b>. For every additional hour of study time per week, the average course mark increased by <span style = "color:#F0D264"><b> 2.89, $SE$ = .24, $p$ < .001, 95% CI = [2.43, 3.36] </span></b>. 
