...
```{r, echo = F, fig.height=4}
ggplot(data = data.frame(t = c(-5, 5)), aes(x=t)) +
  stat_function(fun=dt, geom='line', args=c(df = 15), color = accent3, linewidth=1.5) +
...
ggplot(assumpDat, aes(normDat)) + geom_histogram(fill = accent3, color = accent2, bins = 30) +
...
ggplot(assumpDat, aes(bimodDat)) + geom_histogram(fill = accent3, color = accent2, bins = 30) +
  labs(x='Score', y = 'Count') +
  theme(axis.text = element_text(size = 12),
        axis.title = element_text(size = 14, face = 'bold'))

ggplot(assumpDat, aes(floorDat)) + geom_histogram(fill = accent3, color = accent2, bins = 30) +
  labs(x='Score', y = 'Count') +
  theme(axis.text = element_text(size = 12),
        axis.title = element_text(size = 14, face = 'bold'))
```
...
We conducted a **two-tailed independent-samples $t$-test** to determine the effect of <span style = "color:#F2B66D"> <b> treatment </span></b> on <span style = "color:#F2B66D"> <b>systolic blood pressure (SBP) </span></b>. There was a significant effect of treatment, <span style = "color:#008290"><b> $t$(128) = -3.16, $p$ = .002, 95% CI = [-4.68, -1.08], $d$ = -.55 </span></b>. Specifically, SBP in the treatment group was lower <span style = "color:#30726E"><b> ( $M$ = 136.97, $SD$ = 4.86)</span></b> than SBP in the placebo group <span style = "color:#30726E"><b>( $M$ = 139.85, $SD$ = 5.50)</span></b>.
...
We conducted a **two-tailed paired-samples $t$-test** to determine the effect of <span style = "color:#F2B66D"> <b> treatment  </span></b> on <span style = "color:#F2B66D"> <b>systolic blood pressure (SBP) </span></b>. There was a significant effect of treatment, <span style = "color:#008290"><b> $t$(128) = -6.32, $p$ < .001, 95% CI = [-12.05, -6.18], $d$ = -1.07 </span></b>. Specifically, SBP was lower before the medication was administered <span style = "color:#30726E"><b> ( $M$ = 138.60, $SD$ = 6.67)</span></b> than after taking the medication <span style = "color:#30726E"><b>( $M$ = 147.71, $SD$ = 8.48)</span></b>.
