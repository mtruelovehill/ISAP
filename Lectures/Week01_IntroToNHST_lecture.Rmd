...
ggplot(dat = x, aes(x)) + geom_histogram(bins = 10, color = baseColor, fill = accent1) +
...
```{r, echo=F, fig.width=6.5, fig.height=4, warning = F}
ggplot(dat, aes(x=y)) +
  stat_function(fun = dnorm, geom = 'line', args = c(mean=mean(dat$y), sd = sd(dat$y)), linewidth = 1.5, color = accent2) +
...
ggplot(data.frame(x = c(-4, 4)), aes(x = x)) +
  stat_function(fun=dnorm, geom = "line", linewidth = 1.5, color = accent2) +
  theme(axis.text = element_text(size = 12),
        axis.title = element_text(size = 14, face = 'bold'),
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
...
ggplot(data.frame(x = c(-4, 4)), aes(x = x)) + stat_function(fun=dnorm, geom = "line", linewidth = 1.5, color = accent2) +
  theme(axis.text = element_text(size = 12),
        axis.title = element_text(size = 14, face = 'bold'),
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
...
testDat <- ggplot(data.frame(x = c(8, 32)), aes(x = x)) +
  stat_function(fun=dnorm, args= list(20, 3), geom = "line", linewidth = 1.5, color = accent2) +
  theme(axis.text = element_text(size = 12),
        axis.title = element_text(size = 14, face = 'bold'),
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r, echo = F, fig.height=4}
testDat +
  geom_area(stat = 'function', fun = dnorm, args= list(20, 3), fill = accent1, xlim=c(8, 25), alpha = .8) +
  geom_area(stat = 'function', fun = dnorm, args= list(20, 3), fill = accent3, xlim=c(25, 30), alpha = .8) +
...
```{r, echo = F, fig.height=5}
testDat +
  geom_area(stat = 'function', fun = dnorm, args= list(20, 3), fill = accent1, xlim=c(8, 24), alpha = .8) +
  geom_area(stat = 'function', fun = dnorm, args= list(20, 3), fill = accent3, xlim=c(24, 30), alpha = .8) +
...
ggplot(data.frame(x=rnorm(100, mean = 18, sd = 3)), aes(x)) +
  geom_histogram(aes(y = after_stat(density)), binwidth = .75, fill = accent1, color = baseColor) +
...
baset <- ggplot(data.frame(x=c(-6, 6)), aes(x=x)) +
  stat_function(fun=dt, geom='line', args=c(df = 50), linewidth=1.5, color = accent2) +
  labs(x = 'statistic') +
  theme(axis.text.y = element_blank(),
        axis.title.y = element_blank(),
        axis.ticks.y = element_blank(),
...
baset + geom_vline(xintercept = .75, linewidth = 1.5, color = baseColor) +
  annotate('text', label = 'statistic = 0.75', x = 2.35, y = .3, size = 5)
```
]]
...
(ns <- baset +
  annotate('text', label = 'statistic = 0.75', x = 2.35, y = .3, size = 5) +
  geom_area(stat = 'function', fun = dt, args= list(df = 50), xlim=c(-6, .75), fill = accent1, alpha = .8) +
  annotate('text', label = '~77%', x = -.4, y = .05, color = 'white', size = 5) +
  geom_area(stat = 'function', fun = dt, args= list(df = 50), xlim=c(.75, 6), fill = accent3, alpha = .8) +
...
```{r, echo = F, fig.height=4, fig.width=6}
(sigPlot <- baset +
  geom_vline(xintercept = 3.05, linewidth = 1.5, color = baseColor) +
  annotate('text', label = 'statistic = 3.05', x = 4.6, y = .3, size = 5))
```
]]
...
baset +
  geom_vline(xintercept = 3.05, linewidth = 1.5, color = baseColor) +
  annotate('text', label = 'statistic = 3.05', x = 4.6, y = .3, size = 5) +
  geom_area(stat = 'function', fun = dt, args= list(df = 50), xlim=c(-6, 3.05), fill = accent1, alpha = .8) +
...
.pull-right[
```{r, echo=F, fig.height=4, fig.width=6}
ns + annotate('text', label = 'p = .230', x = 4.5, y = .05, size = 6, color = baseColor) +
...
ggplot(data = data.frame(t = c(-5, 5)), aes(x=t)) +
  ...
  annotate('text', x = 3, y = .3, parse = T, label = paste('alpha == .05'), size = 8, color = baseColor) +
  geom_hline(yintercept = 0, linewidth = 1.5)
```
...
ggplot(data = data.frame(t = c(-5, 5)), aes(x=t)) +
  ...
  theme(axis.text = element_blank(),
        ...
        axis.ticks = element_blank()) +
  annotate('text', x = 3, y = .3, parse = T, label = paste('alpha == .05'), size = 8, color = baseColor) +
  annotate('text', x = 3.25, y = .05, parse = T, label = paste('alpha/2 == .025'), size = 6, color = baseColor) +
  annotate('text', x = -3.25, y = .05, parse = T, label = paste('alpha/2 == .025'), size = 6, color = baseColor) +
  annotate('segment', x= -2.25, xend = 3, y = .06, yend = .28, color = baseColor, linewidth = 1, linetype = 'dashed') +
  annotate('segment', x= 2.4, xend = 3, y = .06, yend = .28, color = baseColor, linewidth = 1, linetype = 'dashed') +
  geom_hline(yintercept = 0, linewidth = 1.5)
```
