...
ggplot(sampDat, aes(ID, Recognition, color = intGroup)) + geom_point() +
...
# 
# (ssMod <- ggplot(sampDat, aes(ID, Recognition, color = intGroup)) + geom_point() +
#   scale_color_manual(values = c(accent3, accent2, baseColor, accent1, '#065473', 'gray34')) + 
#   scale_x_continuous(breaks = seq(1, 18, 1)) +
#    scale_y_continuous(limits = c(10, 35), breaks = seq(10, 35, 5)) + 
#   geom_hline(yintercept = mean(sampDat$SWB), linewidth = 1) +
...
MONICA - SSint = SSmod - (SSiv1+SSiv2); SSmod is calculated first.
